...
class xArmTransform:
    ...
    def Transform(self, relativepos: list, relativerot: list, isLimit=True, isOnlyPosition=False):
        ...
        if self.mount == "left":
            ...
            roll, pitch, yaw = relativerot[2] + self.__initRoll, -1 * relativerot[0] + self.__initPitch, relativerot[1] + self.__initYaw
        
        # if self.mount == "left":
        #     x, y, z = relativepos_mm[0] + self.__initX, -1 * relativepos_mm[2] + self.__initY, relativepos_mm[1] + self.__initZ
        #     roll, pitch, yaw = relativerot[0] + self.__initRoll, -1 * relativerot[2] + self.__initPitch, relativerot[1] + self.__initYaw
